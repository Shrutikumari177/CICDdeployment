  ...
  function (Controller, History, Fragment, MessageToast, MessageBox, JSONModel, Filter, FilterOperator) {
    ...
    return Controller.extend("com.ingenx.nauti.masterdashboard.controller.CurrencyType", {
      ...
      CurSearch: function (oEvent) {
        ...
        let oFilter1 = new sap.ui.model.Filter("waers", sLength === 2 ? sap.ui.model.FilterOperator.EQ : sap.ui.model.FilterOperator.Contains, sValue1);
        let oFilter2 = new sap.ui.model.Filter("ltext", sap.ui.model.FilterOperator.Contains, sValue1);
